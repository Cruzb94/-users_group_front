  ...
  <div class="home">
      ...
      <div id="formContent">
        ...
        <form v-on:submit.prevent="login ">
          <input type="text" id="login" class="fadeIn second" name="login" placeholder="Email" v-model="usuario">
      ...
      axios.post(process.env.VUE_APP_URL+"/api/auth/login", json)
        .then(data => {
          if(data.statusText == 'OK') {
            ...
            localStorage.role =  data.data.user[0].roles[0].name;
            
            alert('Bienvenido '+ data.data.user[0].name);
